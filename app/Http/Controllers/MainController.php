...
class MainController extends Controller
{
    ...
    public function addData(Request $request){
        ...
        $examinationData1 = [
            'patient_id' => $patientId, 
        'clinically_anemic' => ($request->input('clinicallyanemic') === 'yes' ? true : ($request->input('clinically_anemic') === 'no' ? false : null)),
            'jaundiced' => ($request->input('jaundiced') === 'yes'? true : ($request->input('jaundiced') === 'no' ? false : null)),
            'pulse' => $request->input('pulse'),
            'sitting_bp_top' => $request->input('sitting-bp-top'),
            'sitting_bp_low' => $request->input('sitting-bp-low'),
            'standing_bp_top' => $request->input('standing-bp-top'),
            'standing_bp_low' => $request->input('standing-bp-low'),
            'lying_bp_top' => $request->input('lying-bp-top'),
            'lying_bp_low' => $request->input('lying-bp-low'),
            'temp' => $request->input('temp'),
            'temp_desc' => $request->input('temp-desc'),
            'resp_rate' => $request->input('resp-rate'),
            'weight_kg' => $request->input('weight'),
            'height_cm' => $request->input('height'),
            'bsl' => $request->input('bsl'),
            'bsl_desc' => $request->input('bsl-desc'),
            'waist_measurement_cm' => $request->input('waist'),
            'hip_measurement_cm' => $request->input('hip-measurement'),
            'bmi' => $request->input('bmi'),
            'o2_saturation_percent' => $request->input('saturation'),
            'created_at' => now(),
            'updated_at' => now(),
        ];
    ...
    public function editData(Request $request){
        ...
        $angIdNgPasyente = $request->pasyenteId;
        $pasyenteNgay = [
            'first_name' => $request->input('firstName'),
            'last_name' => $request->input('lastName'),
            'preferred_name' => $request->input('preferredName'),
    ...
    DB::table('patient_histories_1')
    ->where('patient_id', $angIdNgPasyente)->update($historyData);

    $examinationData1 = [
        'clinically_anemic' => ($request->input('clinicallyanemic') === 'yes' ? true : ($request->input('clinicallyanemic') === 'no' ? false : null)),
        'jaundiced' => ($request->input('jaundiced') === 'yes'? true : ($request->input('jaundiced') === 'no' ? false : null)),
        'pulse' => $request->input('pulse'),
        'sitting_bp_top' => $request->input('sitting-bp-top'),
        'sitting_bp_low' => $request->input('sitting-bp-low'),
    ...
    DB::table('patient_exam_1')
        ->where('patient_id', $angIdNgPasyente)
        ->update($examinationData1);
            
    $cardioHistoryData = [
        'chest_pain' => ($request->input('chestpain')=== 'yes' ? true : ($request->input('chestpain') === 'no' ? false : null)),
        'dyspnoea' =>($request->input('dyspnoea')=== 'yes' ? true : ($request->input('dyspnoea') === 'no' ? false : null)),
        'orthopnoea' => ($request->input('orthopnoea')=== 'yes' ? true : ($request->input('orthopnoea') === 'no' ? false : null)),
        'nocturnal_dyspnoea' => ($request->input('nocturnaldys')=== 'yes' ? true : ($request->input('nocturnaldys') === 'no' ? false : null)),
        'swollen_ankles' => ($request->input('swollenank')=== 'yes' ? true : ($request->input('swollenank') === 'no' ? false : null)),
        'palpitations' => ($request->input('palpitation')=== 'yes' ? true : ($request->input('palpitation')  === 'no' ? false : null)),
        'claudication' => $request->input('claudication'),
        'updated_at' => now(),
    ];

    DB::table('patient_histories_2')
    ->where('patient_id', $angIdNgPasyente)->update($cardioHistoryData);
    ...
    $examinationData2 = [
        ...
        'intercostal_space' => $request->input('intercostal_space'),
        'heart_sounds' => $request->input('heart_sounds'),
        'no_murmurs' => $request->has('no_murmurs'), 
        'murmur_volume' => $request->input('murmur_volume'),
        'murmur_description' => $request->input('murmur_description'),
        'murmur_radiation' => $request->input('murmur_radiation'),
        'carotid_bruit' => $request->input('carotid_bruit'),
    ...
    DB::table('patient_exam_2')
    ->where('patient_id', $angIdNgPasyente)->update($examinationData2);
          

    $gastroHistoryData = [
         // Foreign key to link to the patient (assuming this table has it)
        'abdominal_pain' => ($request->input('abdominal_pain') === 'yes'),
        'nausea' => ($request->input('nausea') === 'yes'),
        'vomiting' => ($request->input('vomiting') === 'yes'),
        'heartburn' => ($request->input('heartburn') === 'yes'),
    ...
    DB::table('patient_histories_3')
    ->where('patient_id', $angIdNgPasyente)->update($gastroHistoryData);
    ...
    DB::table('patient_exam_3')
    ->where('patient_id', $angIdNgPasyente)->update($abdominalExaminationData);
    ...
    DB::table('patient_histories_4')
    ->where('patient_id', $angIdNgPasyente)->update($neuroHistoryData);
    ...
    DB::table('patient_exam_4')
    ->where('patient_id', $angIdNgPasyente)->update($neuroExaminationData);
    ...
    DB::table('patient_histories_5')
    ->where('patient_id', $angIdNgPasyente)->update($genitoHistoryData);
    ...
    DB::table('patient_exam_5')
    ->where('patient_id', $angIdNgPasyente)->update($urinalysisExaminationData);
    ...
    DB::table('patient_histories_6')
    ->where('patient_id', $angIdNgPasyente)->update($entHistoryData);
    ...
    DB::table('patient_exam_6')
    ->where('patient_id', $angIdNgPasyente)->update($entExaminationData);
    ...
    DB::table('patient_histories_7')
    ->where('patient_id', $angIdNgPasyente)->update($eyeExaminationData);
    ...
    DB::table('patient_exam_7')
    ->where('patient_id', $angIdNgPasyente)->update($ophthalmologicalExaminationData);
    ...
    DB::table('patient_histories_8')
    ->where('patient_id', $angIdNgPasyente)->update($skinHistoryData);
    ...
    DB::table('patient_exam_8')
    ->where('patient_id', $angIdNgPasyente)->update($skinExaminationData);
    ...
    DB::table('patient_histories_9')
    ->where('patient_id', $angIdNgPasyente)->update($musculoskeletalHistoryData);
    ...
    DB::table('patient_exam_9')
    ->where('patient_id', $angIdNgPasyente)->update($musculoskeletalExaminationData);
    ...
    DB::table('patient_histories_10')
    ->where('patient_id', $angIdNgPasyente)->update($gynaecoHistoryData);
    ...
    DB::table('patient_exam_10')
    ->where('patient_id', $angIdNgPasyente)->update($gynaecologicalExaminationData);
    ...
    DB::table('patient_histories_11')
    ->where('patient_id', $angIdNgPasyente)->update($breastExaminationData);
    ...
    DB::table('patient_exam_11')
    ->where('patient_id', $angIdNgPasyente)->update($breastExaminationDetailData);
    ...
    DB::table('patient_exam_12')
    ->where('patient_id', $angIdNgPasyente)->update($mentalHealthHistoryData);
    ...
    DB::table('patient_exam_13')
    ->where('patient_id', $angIdNgPasyente)->update($adlData);
    ...
    DB::table('patient_exam_14')
    ->where('patient_id', $angIdNgPasyente)->update($generalHistoryData);
    ...
    // Insert data into the 'alcohol_intake_histories' table
    DB::table('patient_exam_15')
    ->where('patient_id', $angIdNgPasyente)->update($dataDrinkingBud);
    ...
    DB::table('patient_exam_16')
    ->where('patient_id', $angIdNgPasyente)->update($telelastly);
